///
/// @mainpage	Logger-Arduino-MMA8452Q
///
/// @details	The Arduino (minicore) side of the logger with accelerometer
/// @n
/// @n
...
///
/// @file		Logger_Arduino_MMA8452Q.ino
/// @brief		Main sketch
///
/// @details	<#details#>
/// @n @a		Developed with [embedXcode+](http://embedXcode.weebly.com)
